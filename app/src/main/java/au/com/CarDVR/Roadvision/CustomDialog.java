...
public class CustomDialog extends Dialog{
	...
	public static class Builder {
	    		...
	    		public Builder setNegativeButton(int positiveButtonText,
	    				DialogInterface.OnClickListener listener) {
	    		...
	    		public Builder setNegativeButton(String positiveButtonText,
	    				DialogInterface.OnClickListener listener) {
	    		...
	    		public CustomDialog create() {
	    			...
	    			if (message != null) {
	    				...
	    				((LinearLayout) layout.findViewById(R.id.content_view))
	    						.removeAllViews();
	    				((LinearLayout) layout.findViewById(R.id.content_view)).addView(
