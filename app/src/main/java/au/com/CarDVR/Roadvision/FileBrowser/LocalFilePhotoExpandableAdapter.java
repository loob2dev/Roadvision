...
public class LocalFilePhotoExpandableAdapter extends BaseExpandableListAdapter{
    ...
    public LocalFilePhotoExpandableAdapter(Context paramContext, LayoutInflater paramLayoutInflater, Map<String, List<FileNode>> paramMap, ArrayList<String> paramArrayList)
    {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        String key=this.parent.get(groupPosition);
        if (convertView==null){
            convertView=mInflater.inflate(R.layout.local_filelist_photo_row,null);
            viewTag=new ViewTag(
